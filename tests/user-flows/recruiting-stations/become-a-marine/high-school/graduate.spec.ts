...
test(
  ...
  async ({ page, isMobile }) => {
    ...
    expect(decodedURL).toContain("200 Exhibition Drive");
    expect(decodedURL).toContain("Scarborough");
    expect(decodedURL).toContain("ME");
    expect(decodedURL).toContain("04074");
  }
);
